...
const ChatPage = () => {
  ...
  useEffect(() => {
    const fetchUserId = async () => {
      try {
        const response = await axios.post("http://exchangebitnewbackend.onrender.com/api/v1/users/protectedRoute", {}, {
    ...
    const fetchChatHistory = async () => {
      try {
        const response = await axios.post(`http://exchangebitnewbackend.onrender.com/api/v1/chats/${chatId}`, { userId }, {
          withCredentials: true,
        });
